...
const Navbar = () => {
  ...
  return (
    <nav role="navigation" className="navigation">
      ...
      <div className="navigation__links">
        <ul className="navigation__list">
          <li className="navigation__list-item">
            <a href="#about" className="navigation__list-link">
              About
            </a>
          </li>
          <li className="navigation__list-item">
            <a href="#services" className="navigation__list-link">
              Services
            </a>
          </li>
          <li className="navigation__list-item">
      ...
      <Button className="navigation__menu-icon" onClick={toggleMenuHandler}>
